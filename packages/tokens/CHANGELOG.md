...
- [#42](https://github.com/Volksverpetzer/vvp_design_system/pull/42) [`be79eec`](https://github.com/Volksverpetzer/vvp_design_system/commit/be79eec2a6088fc9fe589cc7a7cb6d9b5d4f2df0) Thanks [@rejas](https://github.com/rejas)! - Fix WCAG AA contrast failures in dark-theme colors and add a `linkText` color token.
